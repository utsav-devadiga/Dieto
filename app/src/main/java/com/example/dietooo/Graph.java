...
import static com.example.dietooo.Bmiheightweight.USER_BMI;
...
public class Graph extends AppCompatActivity {
    ...
    TextView graph_text,portfolio,bmi_status_text,bmi_number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // bmi_number  =findViewById(R.id.bmi_num);
        ...
        portfolio = findViewById(R.id.content_bmi);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                portfolio.setText("Profile completed : " + value);
