...
public class Home extends AppCompatActivity {
    ...
    CardView profileCard, dietCard, workoutCard, recipeCard, dietitianCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workoutCard = findViewById(R.id.workouts_card);
        ...
        firebaseDatabase = FirebaseDatabase.getInstance();
        tipreference = firebaseDatabase.getReference("tips").child(tipNum);
        ...
        workoutCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Home.this, WorkoutActivity.class);
                startActivity(i);
                databaseReference = firebaseDatabase.getReference("users");
                databaseReference.child(firebaseUser.getUid()).child("profile").setValue("Workouts");
