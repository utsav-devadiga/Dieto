...
public class signup extends AppCompatActivity {
    ...
    Integer  workcount = 0,dietcount=0;
        ...
        tooltip.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(@NonNull Tooltip tooltip) {
                try{
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT,"Dieto_Need Help");
                    intent.putExtra(Intent.EXTRA_TEXT,"Dieto");
                            ...
                            .addOnCompleteListener(signup.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Userhelper userhelper = new Userhelper(emailinput, number, passwordinput, initial_Height, initial_Weight, initial_BMI, gender, profile_flag,workcount,dietcount);
